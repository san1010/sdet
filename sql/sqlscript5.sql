...
SELECT a.customer_name AS "Customer Name", a.city, b.salesman_name AS "Salesman", b.salesman_commission  
FROM customers a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id  
...
SELECT a.order_no, a.order_date, a.purchase_amount, b.customer_name AS "Customer Name", b.grade, c.name AS "Salesman", c.commission  
FROM orders a  
